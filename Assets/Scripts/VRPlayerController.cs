...
public class VRPlayerController : NetworkBehaviour
{
	...
	public override void OnStartLocalPlayer ()
	{
		...
		GameObject head = vrCameraRigInstance.GetComponentInChildren<Camera> ().gameObject;
	...
	{
		var controllers = vrCameraRigInstance.GetComponentsInChildren<SteamVR_Behaviour_Pose>();
