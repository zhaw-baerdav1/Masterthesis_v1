...
public class CustomHandPhysics : MonoBehaviour
    {
        [Tooltip("Hand collider prefab to instantiate")]
        public CustomHandCollider handColliderPrefab;
        [HideInInspector]
        public CustomHandCollider handCollider;
        ...
        private void Start()
        {
            ...
            handCollider = ((GameObject)Instantiate(handColliderPrefab.gameObject)).GetComponent<CustomHandCollider>();
