...
public class CustomModalThrowable : CustomThrowable
{
    ...
    protected override void HandHoverUpdate(CustomHand hand)
    {
    ...
    protected override void HandAttachedUpdate(CustomHand hand)
    {
