...
public class CustomInteractable : MonoBehaviour
    ...
    public delegate void OnAttachedToHandDelegate(CustomHand hand);
    public delegate void OnDetachedFromHandDelegate(CustomHand hand);
    ...
    public CustomHand attachedToHand;

    [System.NonSerialized]
    public List<CustomHand> hoveringHands = new List<CustomHand>();
    public CustomHand hoveringHand
    {
        get
        {
