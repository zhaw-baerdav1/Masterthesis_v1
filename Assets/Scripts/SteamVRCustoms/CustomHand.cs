...
public class CustomHand : MonoBehaviour
    {
        ...
        [HideInInspector]
        public List<CustomRenderModel> renderModels = new List<CustomRenderModel>();
        [HideInInspector]
        public CustomRenderModel mainRenderModel;
        [HideInInspector]
        ...
        private void InitController()
        {
            ...
            foreach (CustomRenderModel r in renderModels)
            {
                if (r != null)
            ...
            mainRenderModel = renderModelInstance.GetComponent<CustomRenderModel>();
        ...
        public void SetHoverRenderModel(CustomRenderModel hoverRenderModel)
        {
