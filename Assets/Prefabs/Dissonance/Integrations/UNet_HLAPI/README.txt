...
the Unity HLAPI networking system. To use this package you must have purchased and installed Dissonance - **you will
encounter build errors until you have done this**!

The included demo scene (Assets/Dissonance/Integrations/UNet_HLAPI/Demo/HLAPI Demo) demonstrates the basics of a voice
chat session running in a HLAPI network session. Consult the readme file in the demo folder for details on how to run
