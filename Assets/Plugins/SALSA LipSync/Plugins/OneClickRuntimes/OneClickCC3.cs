	...
	public class OneClickCC3 : OneClickBase
	{
		...
		public static void Setup(GameObject gameObject, AudioClip clip)
		{
			...
			NewConfiguration(OneClickConfiguration.ConfigType.Salsa);
			{
				...
				AddShapeComponent(new []{"^Mouth_Pucker.*$"}, 0.08f, 0f, 0.06f, "Mouth_Pucker", 0.815f, true);
				AddShapeComponent(new []{"^Jaw_Rotate_D.*$"}, 0.08f, 0f, 0.06f, "Jaw_Rotate_D", 0.03f, true); // specific to daz-imported model
				AddShapeComponent(new []{"^W_OO.*$"}, 0.08f, 0f, 0.06f, "W_OO", 0.3f, true); // specific to daz-imported model
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					"CC_Base_Teeth02",
					false, true, true);
				AddShapeComponent(new []{"^Lip_Open.*$"}, 0.08f, 0f, 0.06f, "Lip_Open", 0.791f, true);
				AddShapeComponent(new []{"^Tongue_Raise.*$"}, 0.08f, 0f, 0.06f, "Tongue_Raise", 0.388f, true);
				AddShapeComponent(new []{"^Mouth_Smile.*$"}, 0.08f, 0f, 0.06f, "Mouth_Smile", 0.304f, true);
				AddShapeComponent(new []{"^K_G.*$"}, 0.08f, 0f, 0.06f, "K_G", 1.0f, true); // specific to daz-imported model
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					"CC_Base_Teeth02",
					false, true, true);
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.08f, 0f, 0.06f, "Mouth_Lips_Open", 0.184f, true);
				AddShapeComponent(new []{"^Mouth_Top_Lip_Up.*$"}, 0.08f, 0f, 0.06f, "Mouth_Top_Lip_Up", 1f, true);
				AddShapeComponent(new []{"^Mouth_Bottom_Lip_Under.*$"}, 0.08f, 0f, 0.06f, "Mouth_Bottom_Lip_Under", 0.93f, true);
				AddShapeComponent(new []{"^Mouth_Smile.*$"}, 0.08f, 0f, 0.06f, "Mouth_Smile", 0.346f, true);
				AddShapeComponent(new []{"^Jaw_Rotate_D.*$"}, 0.08f, 0f, 0.06f, "Jaw_Rotate_D", 0.045f, true); // specific to daz-imported model
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					"CC_Base_Teeth02",
					false, true, true);
				AddShapeComponent(new []{"^Tongue_Raise.*$"}, 0.08f, 0f, 0.06f, "Tongue_Raise", 0.091f, true);
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.08f, 0f, 0.06f, "Mouth_Lips_Open", 0.319f, true);
				AddShapeComponent(new []{"^Mouth_Bottom_Lip_Under.*$"}, 0.08f, 0f, 0.06f, "Mouth_Bottom_Lip_Under", 0.938f, true);
				AddShapeComponent(new []{"^Mouth_Top_Lip_Up.*$"}, 0.08f, 0f, 0.06f, "Mouth_Top_Lip_Up", 0.828f, true);
				AddShapeComponent(new []{"^Tongue_Out.*$"}, 0.08f, 0f, 0.06f, "Tongue_Out", 1f, true);
				AddShapeComponent(new []{"^Mouth_Blow.*$"}, 0.08f, 0f, 0.06f, "Mouth_Blow", 0.325f, true);
				AddShapeComponent(new []{"^TH.*$"}, 0.08f, 0f, 0.06f, "TH", 0.468f, true); // specific to daz-imported model
				...
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.08f, 0f, 0.06f, "Mouth_Lips_Open", 0.744f, true);
				AddShapeComponent(new []{"^Mouth_Blow.*$"}, 0.08f, 0f, 0.06f, "Mouth_Blow", 0.562f, true);
				AddShapeComponent(new []{"^Oh.*$"}, 0.08f, 0f, 0.06f, "Oh", 0.432f, true); // specific to daz-imported model
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					"CC_Base_Teeth02",
					false, true, true);
				AddShapeComponent(new []{"^Mouth_Smile.*$"}, 0.08f, 0f, 0.06f, "Mouth_Smile", 0.408f, true);
				AddShapeComponent(new []{"^Mouth_Widen.*$"}, 0.08f, 0f, 0.06f, "Mouth_Widen", 0.725f, true);
				AddShapeComponent(new []{"^Lip_Open.*$"}, 0.08f, 0f, 0.06f, "Lip_Open", 1f, true);
				AddShapeComponent(new []{"^Mouth_Top_Lip_Up.*$"}, 0.08f, 0f, 0.06f, "Mouth_Top_Lip_Up", 0.15f, true);
				AddShapeComponent(new []{"^Mouth_Bottom_Lip_Down.*$"}, 0.08f, 0f, 0.06f, "Mouth_Bottom_Lip_Down", 0.488f, true);
				AddShapeComponent(new []{"^Jaw_Rotate_D.*$"}, 0.08f, 0f, 0.06f, "Jaw_Rotate_D", 0.08f, true); // specific to daz-imported model
				AddShapeComponent(new []{"^EE.*$"}, 0.08f, 0f, 0.06f, "EE", 0.24f, true); // specific to daz-imported model
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					false, true, true);
				AddShapeComponent(new []{"^Tongue_Lower.*$"}, 0.08f, 0f, 0.06f, "Tongue_Lower", 1f, true);
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.08f, 0f, 0.06f, "Mouth_Lips_Open", 0.296f, true);
				AddShapeComponent(new []{"^Mouth_Open.*$"}, 0.08f, 0f, 0.06f, "Mouth_Open", 0.964f, true);
				AddShapeComponent(new []{"^Mouth_Pucker_Open.*$"}, 0.08f, 0f, 0.06f, "Mouth_Pucker_Open", 0.606f, true);
			}
